...
namespace FFmpeg.AutoGen.Example
{
    public sealed unsafe class H264VideoStreamEncoder : IDisposable
    {
        ...
        public H264VideoStreamEncoder(Stream stream, int fps, Size frameSize)
        {
            ...
            var codecId = AVCodecID.AV_CODEC_ID_H264; // 변수 codecId 초기화
            _pCodec = ffmpeg.avcodec_find_encoder(codecId); // _pCodec 선언
            if (_pCodec == null) throw new InvalidOperationException("Codec not found."); // _pCodec이 null이면 예외값 출력
